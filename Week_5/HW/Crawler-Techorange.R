...
id = c(1:3)
URL = paste0("https://buzzorange.com/techorange/page/", id, "/?s=%E9%A6%AC%E6%96%AF%E5%85%8B")

Titles <- function(URL)
{
  html  = read_html(URL)
  title = html_nodes(html, ".entry-header a")
...
Download_every_text <- function(href)
{
  ...
  write.table(getContent, "Crawler-techorange.txt", append=TRUE)
