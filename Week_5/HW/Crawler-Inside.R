...
id = c(1:3)
URL = paste0("https://www.inside.com.tw/page/", id, "?s=%E9%A6%AC%E6%96%AF%E5%85%8B")

Titles <- function(URL)
{
  html  = read_html(URL)
  title = html_nodes(html, ".post_list_item_content .js-auto_break_title")
...
Download_every_text <- function(href)
{
  ...
  write.table(getContent, "Crawler-Inside.txt", append=TRUE)
